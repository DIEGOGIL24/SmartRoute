...
export const ItineraryForm = () => {
  ...
  return (
    <div className="space-y-8">
      <Card className="border-none shadow-[var(--shadow-card)]">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              id="city"
              placeholder="Ej: Barcelona, París, Tokyo..."
              value={city}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="dateRange"
              placeholder="Ej: 15-20 Junio 2024"
              value={dateRange}
      ...
      {itinerary && (
        <Card className="border-l-4 border-l-secondary border-none shadow-[var(--shadow-card)] animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
          <CardHeader>
